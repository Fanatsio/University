...
fcn_segment.py
Usage:
    python fcn_segment.py --input_dir images --output_dir outputs --device cpu
"""
...
def main():
    ...
    # Подготовим палитру цветов (предположим до 21-100 классов — выделим 256)
    ...
    for p in img_paths:
        ...
        # при желании масштабировать до минимальной стороны
